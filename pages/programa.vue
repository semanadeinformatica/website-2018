	...
	<section class="mt-5">
		...
		<div class="container mt-5">
			...
			<div class="tab-content" id="nav-tabContent">
							...
							<table class="table table-borderless text-lowercase">
								...
								<tbody>
									...
									<tr>
										<th class="half-hour" scope="row">16h00</th>
										<td class="talk" rowspan="2">
											<a class="text-dark" href="/talks/jogos-realidade-aumentada">
				...
				<div class="tab-pane fade" id="nav-31-oct" role="tabpanel" aria-labelledby="nav-31-oct-tab">
					<div class="row">
						<div class="offset-lg-2 col-lg-8">
							<table class="table table-borderless text-lowercase">
								<thead>
				...
				<div class="tab-pane fade" id="nav-1-nov" role="tabpanel" aria-labelledby="nav-1-nov-tab">
					<div class="row">
						<div class="offset-lg-2 col-lg-8">
							<table class="table table-borderless text-lowercase">
								<thead>
